...
from analysis_paths import (  # noqa: E402
    ...
    NEW_CONDITION_DIR,
    NEW_CONDITION_SCAN_CSV,
    NEW_CONDITION_STRATEGY_CSV,
    NEW_CONDITION_STRATEGY_MD,
    NEW_CONDITION_WATCHLIST_CSV,
    NEW_CONDITION_WATCHLIST_MD,
    OBS_NEW_CONDITION_CP949_CSV,
    OBS_NEW_CONDITION_DIR,
...
NEW_STRATEGY_CSV = NEW_CONDITION_STRATEGY_CSV
NEW_STRATEGY_MD = NEW_CONDITION_STRATEGY_MD
NEW_SCAN_CSV = NEW_CONDITION_SCAN_CSV
NEW_WATCHLIST_CSV = NEW_CONDITION_WATCHLIST_CSV
NEW_WATCHLIST_MD = NEW_CONDITION_WATCHLIST_MD
NEW_CONFIRMED_CSV = NEW_CONDITION_CONFIRMED_CSV
NEW_CONFIRMED_MD = NEW_CONDITION_CONFIRMED_MD
NEW_OBS_UTF8_CSV = OBS_NEW_CONDITION_UTF8_CSV
NEW_OBS_CP949_CSV = OBS_NEW_CONDITION_CP949_CSV
NEW_OBS_MD = OBS_NEW_CONDITION_MD
