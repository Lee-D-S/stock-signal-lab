...
from analysis_paths import (  # noqa: E402
    ...
    CANDLE_FINAL_OBS_MD as CANDLE_FINAL_OBS_MD_PATH,
    CANDLE_FINAL_SCAN_CSV as CANDLE_FINAL_SCAN_CSV_PATH,
    CANDLE_FINAL_SCAN_MD as CANDLE_FINAL_SCAN_MD_PATH,
    CANDLE_FINAL_SUMMARY_CSV as CANDLE_FINAL_SUMMARY_CSV_PATH,
    CANDLE_FINAL_SUMMARY_MD as CANDLE_FINAL_SUMMARY_MD_PATH,
    CANDLE_HISTORY_FINAL_OBS_CSV as CANDLE_HISTORY_FINAL_OBS_CSV_PATH,
    CANDLE_HISTORY_FINAL_OBS_MD as CANDLE_HISTORY_FINAL_OBS_MD_PATH,
    CANDLE_HISTORY_FINAL_SCAN_CSV as CANDLE_HISTORY_FINAL_SCAN_CSV_PATH,
    CANDLE_HISTORY_FINAL_SCAN_MD as CANDLE_HISTORY_FINAL_SCAN_MD_PATH,
    CANDLE_HISTORY_FINAL_SUMMARY_CSV as CANDLE_HISTORY_FINAL_SUMMARY_CSV_PATH,
    CANDLE_HISTORY_FINAL_SUMMARY_MD as CANDLE_HISTORY_FINAL_SUMMARY_MD_PATH,
    CANDLE_HISTORY_OBS_CSV as CANDLE_HISTORY_OBS_CSV_PATH,
    CANDLE_HISTORY_OBS_MD as CANDLE_HISTORY_OBS_MD_PATH,
    CANDLE_HISTORY_SCAN_CSV as CANDLE_HISTORY_SCAN_CSV_PATH,
    CANDLE_HISTORY_SCAN_MD as CANDLE_HISTORY_SCAN_MD_PATH,
    CANDLE_HISTORY_SUMMARY_CSV as CANDLE_HISTORY_SUMMARY_CSV_PATH,
    CANDLE_HISTORY_SUMMARY_MD as CANDLE_HISTORY_SUMMARY_MD_PATH,
    CANDLE_SCAN_CSV as CANDLE_SCAN_CSV_PATH,
    CANDLE_SCAN_MD as CANDLE_SCAN_MD_PATH,
    OBS_CSV as OBS_CSV_PATH,
    OBS_MD as OBS_MD_PATH,
    OBS_SUMMARY_CSV as OBS_SUMMARY_CSV_PATH,
    OBS_SUMMARY_MD as OBS_SUMMARY_MD_PATH,
    UNIVERSE_MASTER_CSV,
)

UNIVERSE_CSV = UNIVERSE_MASTER_CSV
SCAN_CSV = CANDLE_SCAN_CSV_PATH
SCAN_MD = CANDLE_SCAN_MD_PATH
OBS_CSV = OBS_CSV_PATH
OBS_MD = OBS_MD_PATH
SUMMARY_CSV = OBS_SUMMARY_CSV_PATH
SUMMARY_MD = OBS_SUMMARY_MD_PATH
FINAL_SCAN_CSV = CANDLE_FINAL_SCAN_CSV_PATH
FINAL_SCAN_MD = CANDLE_FINAL_SCAN_MD_PATH
FINAL_OBS_CSV = CANDLE_FINAL_OBS_CSV_PATH
FINAL_OBS_MD = CANDLE_FINAL_OBS_MD_PATH
FINAL_SUMMARY_CSV = CANDLE_FINAL_SUMMARY_CSV_PATH
FINAL_SUMMARY_MD = CANDLE_FINAL_SUMMARY_MD_PATH
HISTORY_SCAN_CSV = CANDLE_HISTORY_SCAN_CSV_PATH
HISTORY_SCAN_MD = CANDLE_HISTORY_SCAN_MD_PATH
HISTORY_OBS_CSV = CANDLE_HISTORY_OBS_CSV_PATH
HISTORY_OBS_MD = CANDLE_HISTORY_OBS_MD_PATH
HISTORY_SUMMARY_CSV = CANDLE_HISTORY_SUMMARY_CSV_PATH
HISTORY_SUMMARY_MD = CANDLE_HISTORY_SUMMARY_MD_PATH
HISTORY_FINAL_SCAN_CSV = CANDLE_HISTORY_FINAL_SCAN_CSV_PATH
HISTORY_FINAL_SCAN_MD = CANDLE_HISTORY_FINAL_SCAN_MD_PATH
HISTORY_FINAL_OBS_CSV = CANDLE_HISTORY_FINAL_OBS_CSV_PATH
HISTORY_FINAL_OBS_MD = CANDLE_HISTORY_FINAL_OBS_MD_PATH
HISTORY_FINAL_SUMMARY_CSV = CANDLE_HISTORY_FINAL_SUMMARY_CSV_PATH
HISTORY_FINAL_SUMMARY_MD = CANDLE_HISTORY_FINAL_SUMMARY_MD_PATH
