...
| 데이터 | 위치 |
|---|---|
| 기업별 기존 분석 | `legacy/research_data/ai 주가 변동 원인 분석/00_기업별분석/` |
| 기획/기준 문서 | `legacy/research_data/ai 주가 변동 원인 분석/01_기획/`, `02_기준/` |
| 원천 데이터 | `legacy/research_data/ai 주가 변동 원인 분석/03_원천데이터/` |
| 가설 검토 | `legacy/research_data/ai 주가 변동 원인 분석/05_가설검토/` |
| 백테스트 | `legacy/research_data/ai 주가 변동 원인 분석/06_백테스트/` |
| 전략 신호 | `legacy/research_data/ai 주가 변동 원인 분석/07_전략신호/` |
| 관찰 기록 | `legacy/research_data/ai 주가 변동 원인 분석/08_관찰기록/` |
| 일일 요약 | `legacy/research_data/ai 주가 변동 원인 분석/10_일일요약/` |
