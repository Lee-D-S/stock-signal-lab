...
The fixed-universe experiment uses the 50-company 2024-12-31 roster, 58 price-volume and market-relative features, and next-trading-day direction labels. The current v4 feature set includes v2 price shape plus equal-weight KOSPI/KOSDAQ market and market-relative returns over 1, 5, 20, and 60 trading days. It evaluates four candidates with 2020-2024 expanding folds and writes 2025 model-level plus equal-weight ensemble predictions.
